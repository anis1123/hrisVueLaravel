...
@section('title', get_company_info('company_name').' | User Update')
@section('head')
    <!-- DataTables -->
...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
                <div class="col-md-4">
                    <form id="TypeValidation" class="form-horizontal" action="{{route('super.users.update',$user->id)}}"
                          method="post">
                        @method('PUT')
                        <div class="card ">
