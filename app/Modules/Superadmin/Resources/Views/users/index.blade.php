...
@endsection
@section('title', get_company_info('company_name').' | User List')
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
                <div class="col-md-4">
                    <form action="{{route('super.users.getcompanyroles')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="company_id" id="company_id" class="select2 form-control" required>
                                        ...
                                        @foreach(get_company_lists() as $company)
                                            ...
                                            @if($company_id==$company->id) selected @endif>{{ucfirst($company->company_name)}}</option>
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <form id="TypeValidation" class="form-horizontal" action="{{route('super.users.store')}}"
                          method="post">
                        <div class="card ">
...
@section('script')
    ...
    <script>
        function confirmDelete(id) {
            var url = '{{ route("super.users.delete", ":id") }}';
