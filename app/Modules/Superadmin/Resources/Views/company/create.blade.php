...
@section('content')
    ...
    <section class="content">
        <div style="">
            <form action="{{route('super.company.store')}}" method="POST" enctype="multipart/form-data">
                {{--@method("PUT")--}}
                {{csrf_field()}}
                <div class="row">
                    <div class="col-md-4 ">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title"> Admin Login Information:</h3>
                    ...
                    <div class="col-md-6">
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <h3 class="text-center">Company ID: {{$company_id}}</h3>
                                <div class="form-group">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                            ...
                                            <div class="fileinput-new img-thumbnail"
                                                ...
                                                @if(old('logo')!=null)
                                                    <img src="{{url('/').Storage::url(old('logo'))}}"/>
                                                @else<img
