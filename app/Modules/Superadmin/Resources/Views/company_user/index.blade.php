...
@endsection
@section('title', get_company_info('company_name').' | Assign Users to Company')
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4">
                <form id="TypeValidation" class="form-horizontal" action="{{route('super.company_users.store')}}"
                      method="post">
                    <div class="card ">
