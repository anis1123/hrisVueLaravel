            ...
            <div class="card-body">
                <form action="{{ route('user.login') }}" method="POST">
                    ...
                    <div class="input-group form-group">
                        ...
                        <input type="text" class="form-control @error('text') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="text" autofocus placeholder="username">
